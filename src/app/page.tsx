      ...
      <main>
            ...
            <div className="max-w-5xl text-left">
              <h1 className="font-bold text-white leading-tight">
                ...
                <div className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl">
                  <span className="bg-[#fcf3cc] text-orange-500 px-3 lg:px-4 py-1 lg:py-2 rounded-lg inline-block">
                    ORATOR
                  </span>
                </div>
              </h1>
              <p className="text-lg sm:text-xl md:text-2xl text-gray-300 mb-8 lg:mb-12 max-w-4xl leading-relaxed mt-6">
                Where words meet wisdom and voices find their power. Join IIIT
                Nagpur's premier debate and public speaking club.
              </p>
        ...
        <section className="py-16 lg:py-24 bg-gray-900">
          <div className="container mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 max-w-7xl mx-auto">
              <div className="text-center p-6 lg:p-8 rounded-xl bg-black border border-gray-800 hover:border-gray-700 transition-all duration-300 hover:transform hover:scale-105 shadow-lg">
                ...
                <h3 className="text-base lg:text-xl font-semibold text-white mb-3 lg:mb-4">
                  Public Speaking
                </h3>
        ...
        <section className="py-16 lg:py-24 bg-black">
          <div className="container mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 mb-12 lg:mb-16 max-w-7xl mx-auto">
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 lg:p-8 hover:border-gray-700 hover:transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl">
                <div className="text-orange-500 text-sm font-semibold mb-3 lg:mb-4 tracking-wide">
                  FEBRUARY 15, 2025
                </div>
                <h3 className="text-xl lg:text-2xl font-bold text-white mb-3 lg:mb-4 leading-tight">
                  Parliamentary Debate Workshop
                </h3>
                <p className="text-gray-400 mb-4 lg:mb-6 leading-relaxed">
                  Learn the fundamentals of parliamentary style debating with
                  expert guidance and hands-on practice.
                </p>
                <Link
                  href="/events"
                  className="text-white font-semibold hover:text-orange-400 transition-colors inline-flex items-center gap-2 group"
                >
                  Learn More
                  <ArrowRight
                    size={16}
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 lg:p-8 hover:border-gray-700 hover:transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl">
                ...
                <p className="text-gray-400 mb-4 lg:mb-6 leading-relaxed">
                  Compete against the best debaters from colleges across the
                  region in this prestigious tournament.
                </p>
                <Link
                  href="/events"
                  className="text-white font-semibold hover:text-orange-400 transition-colors inline-flex items-center gap-2 group"
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 lg:p-8 hover:border-gray-700 hover:transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-2xl md:col-span-2 lg:col-span-1">
                <div className="text-orange-500 text-sm font-semibold mb-3 lg:mb-4 tracking-wide">
                  MARCH 1, 2025
                </div>
                <h3 className="text-xl lg:text-2xl font-bold text-white mb-3 lg:mb-4 leading-tight">
            ...
            <div className="text-center">
              <Link
                href="/events"
                className="bg-white hover:bg-gray-100 text-black px-10 lg:px-12 py-4 lg:py-5 rounded-lg font-semibold text-lg lg:text-xl transition-all duration-300 inline-flex items-center gap-2 shadow-lg hover:shadow-xl transform hover:scale-105"
              >
        ...
        <section className="py-16 lg:py-24 bg-gray-900 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 lg:px-8 text-center relative z-10">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg lg:text-xl text-gray-400 mb-10 lg:mb-12 max-w-3xl mx-auto leading-relaxed">
